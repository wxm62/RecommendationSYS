...
s1 = 1 - i1  # 易感者比例的初值
Y1 = (i1, s1)  # 微分方程组的初值
print(i1) # 0.7086915017524091 0.6443744894307698

i2 = 89 / number  # 患病者比例的初值 全部节点
s2 = 1 - i2  # 易感者比例的初值
Y2 = (i2, s2)  # 微分方程组的初值
...
plt.title("SIR models in Email-Dept3")
...
plt.savefig('SIR模型-Email-Dept3.pdf')
plt.show()
