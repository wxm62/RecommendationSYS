...
# data = pd.read_csv('importance_dept4从大到小.csv')
# dat1 = data['node'].array

# kshelldata = pd.read_csv('result-kshell2从大到小.csv')
# dat1 = kshelldata['nodeid'].array # 0.03546099290780142

# bcdata = pd.read_csv('result_bc从大到小.csv')
# dat1 = bcdata['node'].array #0.10658275896513834

ccdata = pd.read_csv('result_cc从大到小.csv')
dat1 = ccdata['node'].array  # 0.03745879532514235

degreedata = pd.read_csv('result_degree从大到小.csv')
dat2 = degreedata['nodeid'].array  # 0.270002996703626
