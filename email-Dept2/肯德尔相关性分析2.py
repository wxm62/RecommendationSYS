...
# data = pd.read_csv('importance_dept2从大到小.csv')
# dat1 = data['node'].array

# kshelldata = pd.read_csv('result-kshell2从大到小.csv')
# dat1 = kshelldata['nodeid'].array #0.17322291235334714

bcdata = pd.read_csv('result_bc从大到小.csv')
dat1 = bcdata['node'].array #0.1066635994172226

ccdata = pd.read_csv('result_cc从大到小.csv')
dat2 = ccdata['node'].array  # -0.01403266620657925

# degreedata = pd.read_csv('result_degree从大到小.csv')
# dat1 = degreedata['nodeid'].array  # 0.14193696802392455
